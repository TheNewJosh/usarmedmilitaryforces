...
<body>
    ...
    <form action="components/action-login.php" method="post">
        <h3>Login Here</h3>

        <label for="password">Pass Code</label>
        <input type="password" name="passcode" placeholder="Password" id="password" required>

        <button name="submit_login" type="submit">Log In</button>
        <div class="social">
          <a href="index.php" class="go"><i class="fas fa-home"></i>  Home</a>
        </div>
    </form>
</body>
</html>
